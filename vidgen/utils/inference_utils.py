...
from vidgen.datasets import IMG_FPS
from vidgen.datasets.utils import read_from_path
...
def get_save_path_name(
    ...
    sample_name_suffix = prompt[0:150] if prompt_as_path else f"_{sample_idx:04d}"
