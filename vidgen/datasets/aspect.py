...
ASPECT_RATIOS = {
    ...
    "240p": (min([v[0] * v[1] for v in ASPECT_RATIO_240P.values()]), ASPECT_RATIO_240P),
    "360p": (230400, ASPECT_RATIO_360P),
    "512": (262144, ASPECT_RATIO_512),
    "480p": (min([v[0] * v[1] for v in ASPECT_RATIO_480P.values()]), ASPECT_RATIO_480P),
    "720p": (min([v[0] * v[1] for v in ASPECT_RATIO_720P.values()]), ASPECT_RATIO_720P),
    "720p_div64": (min([v[0] * v[1] for v in ASPECT_RATIO_720P_DIV64.values()]), ASPECT_RATIO_720P_DIV64),
