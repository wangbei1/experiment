...
dataset = dict(
    ...
    transform_name="resize_crop",
    data_path="/home/dufei.df/huaniu_workspace/Data/video_data_360M_filtered_240p_4s_bs4_node32/split_data_{}.feather",
    image_data_path="/home/dufei.df/huaniu_workspace/Data/image_data_vcg_joy_smalltest_1024_bs2_node32/split_data_{}.parquet",
    image_percent=0.1,
    sample_fps=16,
)
...
exp_flag = "mochi_stage1"#"maskdit-fulltoken"
maskdit = False
