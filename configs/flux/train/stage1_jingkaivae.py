...
bucket_config = {  # 12s/it
    ...
    # # ---
    # "360p": {1: (0.2, 3)},
    # "512": {1: (1, 72), 48: (1.0, 12), 96: ((1.0, 0.33), 6)},
    # # ---
    # "480p": {1: (0.5, 48), 48: (0.5, 8), 96: ((0.5, 0.33), 4)},
    # ---
    # "720p": {1: (0.3, 24), 48: (0.3, 4), 96: ((0.3, 0.33), 2)},
    "240p": {16*4: (1.0, 1)},
    # "512": {96: (1.0, 6)}
    # "1024": {1: (0.05, 36)},
    # ---
...
exp_flag = None #"maskdit-fulltoken"
maskdit = False
...
model = dict(
    type="Flux-3D",
    # from_pretrained="/home/dufei.df/aigc/VidGen/outputs/032-Flux-3D/epoch0-global_step6000/ema",
    patch_size = 2,
    in_channels = 64,
    num_layers = 19,
...
vae = dict(
    ...
    from_pretrained="/home/dufei.df/models/aigc/video_vae/checkpoint-stage3-final.pth",
)
