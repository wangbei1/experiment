...
t5 = dict(
    ...
    text_len=text_len,
    dtype=dtype,
    checkpoint_path='/mnt/weining.wjw/03-Checkpoints/wanx2.1-t2v/cache/models_t5_umt5-xxl-enc-bf16.pth', # TODO.
    tokenizer_path='/mnt/weining.wjw/03-Checkpoints/wanx2.1-t2v/cache/google/umt5-xxl') # TODO.

vae = dict(
    type="WanX21_VAE",
    vae_pth="/mnt/weining.wjw/03-Checkpoints/wanx2.1-t2v/cache/vae.pth",) # TODO.
