        ...
        with tqdm(
            ...
            for step, batch in pbar:
                ...
                with timers["move_data"] as move_data_t:
                    x = batch.pop("video").to(device)  # [B, C, T, H, W]
                    y = batch.pop("text")
                if record_time:
                ...
                if enable_ulysses_sp:
                    model_args["enable_ulysses_sp"] = True
                    
                # == diffusion loss computation ==
                with timers["diffusion"] as loss_t:
                    model_args["temporal_reduction_factor"] = vae.downsample_factor[0]
