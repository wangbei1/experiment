...
from vidgen.datasets import save_sample_imageio
...
def main():
    ...
    data_parallel_size = para_dist.parallel_state.get_data_parallel_size()
    data_parallel_rank = para_dist.parallel_state.get_data_parallel_rank()
    sp_parallel_rank = para_dist.parallel_state.get_sequence_parallel_rank()
    ...
    for i in range(0, len(prompts), batch_size):
        ...
        # TODO: move vae model to this function
